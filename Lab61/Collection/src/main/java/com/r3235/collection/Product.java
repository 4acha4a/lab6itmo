...
public class Product implements Serializable, Comparable<Product>
{
    ...
    public Product(int id, String name, Coordinates coordinates, ZonedDateTime creationDate, double price, UnitOfMeasure unitOfMeasure, Organization manufacturer){
        this.id = id;
        this.name = name;
